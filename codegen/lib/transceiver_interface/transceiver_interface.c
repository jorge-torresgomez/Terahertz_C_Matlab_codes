 ...
 *                const double bits[8000]
 *                double bit_rate
 *                double A
 *                double Const_Tx_real[8000]
 *                double Const_Tx_imag[8000]
...
void transceiver_interface(
    ...
    double nanosensor_pos_x[8000])
{
  memset(&Const_Tx_real[0], 0, 8000U * sizeof(double));
  memset(&Const_Tx_imag[0], 0, 8000U * sizeof(double));
