 ...
 * File: _coder_channel_gain_api.c
 *
...
void channel_gain_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  ...
  Freq_THz = channel_gain(Freq_THz, Comm_dist, Skin_thickness, Tissue_thickness,
                          Vessel_thickness);
...
void channel_gain_atexit(void)
{
  ...
  channel_gain_xil_terminate();
  channel_gain_xil_shutdown();
...
/*
 * File trailer for _coder_channel_gain_api.c
 *
 * [EOF]
 */
