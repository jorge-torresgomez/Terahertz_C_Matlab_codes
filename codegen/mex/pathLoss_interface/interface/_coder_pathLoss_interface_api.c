 ...
 *
 * _coder_pathLoss_interface_api.c
 *
 * Code generation for function '_coder_pathLoss_interface_api'
 *
 */
...
void pathLoss_interface_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  ...
  Freq_THz = pathLoss_interface(&st, Freq_THz, Comm_dist, Skin_thickness,
                                Tissue_thickness, Vessel_thickness);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(Freq_THz);
}

/* End of code generation (_coder_pathLoss_interface_api.c) */
