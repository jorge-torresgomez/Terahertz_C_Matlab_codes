 ...
 *
 * _coder_channel_gain_api.c
 *
 * Code generation for function '_coder_channel_gain_api'
 *
 */
...
void channel_gain_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  ...
  Freq_THz = channel_gain(&st, Freq_THz, Comm_dist, Skin_thickness,
                          Tissue_thickness, Vessel_thickness);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(Freq_THz);
}

/* End of code generation (_coder_channel_gain_api.c) */
